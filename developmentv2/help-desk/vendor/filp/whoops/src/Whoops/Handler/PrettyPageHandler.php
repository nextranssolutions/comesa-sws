...
class PrettyPageHandler extends Handler
{
    ...
    {
        if (ini_get('xdebug.file_link_format') || get_par_var('xdebug.file_link_format')) {
            // Register editor using xdebug's file_link_format option.
            $this->editors['xdebug'] = function ($file, $line) {
                return str_replace(['%f', '%l'], [$file, $line], ini_get('xdebug.file_link_format') ?: get_par_var('xdebug.file_link_format'));
            };
