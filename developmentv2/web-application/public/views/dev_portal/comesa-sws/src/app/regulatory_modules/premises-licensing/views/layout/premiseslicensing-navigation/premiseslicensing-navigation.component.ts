...
@Component({
  selector: 'app-premiseslicensing-navigation',
  templateUrl: './premiseslicensing-navigation.component.html',
  styleUrl: './premiseslicensing-navigation.component.css'
})
export class PremiseslicensingNavigationComponent {
nav_data: any;
  ...
  constructor(
    ...
    this.regulatory_function_id = this.regulatory_data.regulatory_function_id;
  ...
  navigationClickEvent(childGroup: any): void {
    ...
    this.router.navigate(['./premises-licensing/' + routerlink]);
    this.scrollToTop();
  }
