...
@Component({
  selector: 'app-approved-exportapplication-permits',
 
  templateUrl: './approved-exportapplication-permits.component.html',
  styleUrl: './approved-exportapplication-permits.component.css'
})
export class ApprovedExportapplicationPermitsComponent extends SharedImpExpdashboardClass {
  ...
  ngOnInit(): void {
    ...
    let appworkflowstage_category_id = 10;
