...
export class DataEntryFormSetupComponent {
  ...
  constructor(
    ...
    this.table_name = 'par_dataentry_formsetup';
  ...
  onGetApplicationFormFields() {
    this.spinnerShow('Loading...........');
    var data_submit = {
      'table_name': 'par_dataentry_formfields',
  ...
  onFuncSaveApplicationFormFieldData() {
    ...
    this.configService.onSaveConfigurationDetailsDetails('par_dataentry_formfields', this.applicationFormFieldsFrm.value, 'onsaveConfigData')
      .subscribe(
        response => {
          this.response = response;
          //the details 
