...
@Component({
  selector: 'app-shared-processconfigs',

  templateUrl: './shared-processconfigs.component.html',
  styleUrl: './shared-processconfigs.component.css'
})
export class SharedProcessconfigsComponent {
