...
export class DocumentRequirementDefinationComponent {
  ...
  constructor(
    ...
    this.table_name = 'dms_documentrequirements_defination';
    this.parameter_name = "document_requirement_defination";
    ...
    this.createNewDataFrm = new FormGroup({
      ...
      document_extensions_id: new FormControl('', Validators.compose([])),
  ...
  ngOnInit() {
    ...
    this.onLoaddocumetnExtensionsData();
  ...
  onFuncSaveNewConfigData() {
    ...
    this.configService.onSaveConfigurationDetailsDetails(this.table_name, this.createNewDataFrm.value, 'onSaveDocumentRequirements')
      .subscribe(
        response => {
  ...
  fetchNewConfigData() {
    ...
    this.configService.onLoadConfigurationData(data_submit, 'onLoadDocumentRequriementrecords')
      .subscribe(
        data => {
          this.data_record = data;
          ;
  ...
  onLoaddocumetnExtensionsData() {

    var data_submit = {
      'table_name': 'dms_document_extension_types'
    }
    this.configService.onLoadConfigurationData(data_submit)
      .subscribe(
        data => {
          ...
          if (this.data_record.success) {
            this.documetnExtensionsData = this.data_record.data;
            ;
          }
        });
