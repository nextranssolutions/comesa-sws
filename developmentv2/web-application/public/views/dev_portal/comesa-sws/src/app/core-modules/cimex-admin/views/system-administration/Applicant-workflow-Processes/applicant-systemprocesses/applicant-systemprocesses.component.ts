...
@Component({
  selector: 'app-applicant-systemprocesses',

  templateUrl: './applicant-systemprocesses.component.html',
  styleUrl: './applicant-systemprocesses.component.css'
})
export class ApplicantSystemprocessesComponent {
  table_name: string;
