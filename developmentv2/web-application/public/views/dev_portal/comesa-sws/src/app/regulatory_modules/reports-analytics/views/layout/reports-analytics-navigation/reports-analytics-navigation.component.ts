...
@Component({
  selector: 'app-reports-analytics-navigation',
  templateUrl: './reports-analytics-navigation.component.html',
  styleUrl: './reports-analytics-navigation.component.css'
})
export class ReportsAnalyticsNavigationComponent {
 nav_data: any;
  ...
  navigationClickEvent(childGroup: any): void {
    ...
    this.router.navigate(['./reports-analytics/' + routerlink]);
    this.scrollToTop();
