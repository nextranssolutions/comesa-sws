...
@Component({
  selector: 'app-sharedrevenueconfigurations',
  templateUrl: './sharedrevenueconfigurations.component.html',
  styleUrl: './sharedrevenueconfigurations.component.css'
})
export class SharedrevenueconfigurationsComponent {
 ...
 @Input() table_name: string;
  ...
  fetchFeeTypesDetails() {
    ...
    this.revenueService.onLoadConfigurationData(data_submit)
      .subscribe(
        data => {
  ...
  onFuncSaveCountriesData() {
    ...
    this.revenueService.onSaveConfigurationDetailsDetails(this.table_name, this.createNewDataFrm.value, 'onsaveConfigData')
      .subscribe(
        response => {
  ...
  onDeleteConfigurationsDetails() {
    ...
    this.revenueService.onDeleteConfigurationsDetails(this.createNewDataFrm.value, this.table_name, this.parameter_name)
      .subscribe(
        response => {
          this.spinner.hide();
          this.response = response;
  ...
  iniateEnableDisableRecord() {
    ...
    this.revenueService.onEnableConfigurationsDetails(this.createNewDataFrm.value, this.table_name, this.parameter_name)
      .subscribe(
        response => {
          this.spinner.hide();
          this.response = response;
