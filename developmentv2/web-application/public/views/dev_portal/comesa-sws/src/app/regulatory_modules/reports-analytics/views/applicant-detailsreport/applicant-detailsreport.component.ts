...
@Component({
  selector: 'app-applicant-detailsreport',
  templateUrl: './applicant-detailsreport.component.html',
  styleUrl: './applicant-detailsreport.component.css'
})
export class ApplicantDetailsreportComponent {
