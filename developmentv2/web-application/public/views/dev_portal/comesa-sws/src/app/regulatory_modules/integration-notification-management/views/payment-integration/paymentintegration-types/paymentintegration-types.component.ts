...
@Component({
  selector: 'app-paymentintegration-types',
  templateUrl: './paymentintegration-types.component.html',
  styleUrl: './paymentintegration-types.component.css'
})
export class PaymentintegrationTypesComponent {
table_name: string = 'par_paymentintegration_types';
  parameter_name: string = 'payment_integration_types';
