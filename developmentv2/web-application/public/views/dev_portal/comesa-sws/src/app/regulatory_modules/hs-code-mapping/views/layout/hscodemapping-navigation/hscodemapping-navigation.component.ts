...
@Component({
  selector: 'app-hscodemapping-navigation',
  templateUrl: './hscodemapping-navigation.component.html',
  styleUrl: './hscodemapping-navigation.component.css'
})
export class HscodemappingNavigationComponent {
