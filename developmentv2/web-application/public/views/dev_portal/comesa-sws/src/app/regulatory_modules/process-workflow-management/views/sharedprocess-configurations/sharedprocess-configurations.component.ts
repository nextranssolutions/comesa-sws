...
@Component({
  selector: 'app-sharedprocess-configurations',

  templateUrl: './sharedprocess-configurations.component.html',
  styleUrl: './sharedprocess-configurations.component.css'
})
export class SharedprocessConfigurationsComponent {
