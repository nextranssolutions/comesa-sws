...
@Component({
  selector: 'app-revenuemngnt-navigation',
  
  templateUrl: './revenuemngnt-navigation.component.html',
  styleUrl: './revenuemngnt-navigation.component.css'
})
export class RevenuemngntNavigationComponent {
  nav_data: any;
        ...
        navigationClickEvent(childGroup: any): void {
          ...
          // this.scrollToTop();
          this.router.navigate(['./revenue-management/' + routerlink]);
          this.scrollToTop();
        }
