    ...
    this.expertsProfileService.onLoadExpertsConfigData(data_submit)
      .subscribe(
        data => {
          this.data_record = data;
          if (this.data_record.success) {
            this.genderData = this.data_record.data;
          }
        },
        error => {
    ...
    this.expertsProfileService.onLoadExpertsConfigData(data_submit)
      .subscribe(
        data => {
          this.data_record = data;
          if (this.data_record.success) {
            this.levelsofExperienceData = this.data_record.data;
          }
        },
        error => {
    ...
    this.expertsProfileService.onLoadExpertsConfigData(data_submit)
      .subscribe(
        data => {
          this.data_record = data;
          if (this.data_record.success) {
            this.levelOfstudyData = this.data_record.data;
          }
        },
        error => {
    ...
    this.expertsProfileService.onLoadExpertsConfigData(data_submit)
      .subscribe(
        data => {
          this.data_record = data;
          if (this.data_record.success) {
            this.languagesData = this.data_record.data;
          }
        },
        error => {
    ...
    this.expertsProfileService.onLoadExpertsConfigData(data_submit)
      .subscribe(
        data => {
          this.data_record = data;
          if (this.data_record.success) {
            this.langproficiencyLevelsData = this.data_record.data;
          }
        },
        error => {
    ...
    this.expertsProfileService.onLoadExpertsConfigData(data_submit)
      .subscribe(
        data => {
          this.data_record = data;
          if (this.data_record.success) {
            this.employerBusinessTypeData = this.data_record.data;
          }
        },
        error => {
    ...
    this.expertsProfileService.onLoadExpertsConfigData(data_submit)
      .subscribe(
        data => {
          this.data_record = data;
          if (this.data_record.success) {
            this.fieldIndustryData = this.data_record.data;
          }
        },
        error => {
    ...
    this.expertsProfileService.onLoadExpertsConfigData(data_submit)
      .subscribe(
        data => {
          this.data_record = data;
          if (this.data_record.success) {
            this.publicationTypesData = this.data_record.data;
          }
        },
        error => {
...
loadData(message, tableName, id, dataVariable) {
    ...
    this.expertsProfileService.onLoadExpertsProfileDataUrl(data_submit, 'onLoadExpertsConfigData')
        .subscribe(
            data => {
                this.data_record = data;
                if (this.data_record.success) {
                    this[dataVariable] = this.data_record.data;
                }
                this.spinnerHide();
            },
            error => {
