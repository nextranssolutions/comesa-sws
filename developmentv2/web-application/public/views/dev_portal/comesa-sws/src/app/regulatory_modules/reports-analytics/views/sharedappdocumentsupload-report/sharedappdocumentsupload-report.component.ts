...
@Component({
  selector: 'app-sharedappdocumentsupload-report',

  templateUrl: './sharedappdocumentsupload-report.component.html',
  styleUrl: './sharedappdocumentsupload-report.component.css'
})
export class SharedappdocumentsuploadReportComponent implements OnChanges {
