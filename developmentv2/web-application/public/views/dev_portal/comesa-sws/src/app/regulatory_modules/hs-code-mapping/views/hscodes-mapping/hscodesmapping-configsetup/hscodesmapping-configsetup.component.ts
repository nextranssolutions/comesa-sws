...
@Component({
  selector: 'app-hscodesmapping-configsetup',
  templateUrl: './hscodesmapping-configsetup.component.html',
  styleUrl: './hscodesmapping-configsetup.component.css'
})
export class HscodesmappingConfigsetupComponent {
  table_name: string;
