...
@Component({
  selector: 'app-shared-timeframeconfigurations',
  templateUrl: './shared-timeframeconfigurations.component.html',
  styleUrl: './shared-timeframeconfigurations.component.css'
})
export class SharedTimeframeconfigurationsComponent {
    ...
    this.configService.onLoadConfigurationData(data_submit)
      .subscribe(
        data => {
          this.data_record = data;
          if (this.data_record.success) {
            this.prodTypeData = this.data_record.data
          }
        },
        error => {
