...
@Component({
  selector: 'app-applicant-workflow-interfaces',
 
  templateUrl: './applicant-workflow-interfaces.component.html',
  styleUrl: './applicant-workflow-interfaces.component.css'
})
export class ApplicantWorkflowInterfacesComponent {
  table_name: string;
