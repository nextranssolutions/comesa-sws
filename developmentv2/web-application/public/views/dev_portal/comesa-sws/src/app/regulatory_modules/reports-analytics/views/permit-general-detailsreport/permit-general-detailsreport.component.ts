...
@Component({
  selector: 'app-permit-general-detailsreport',
  templateUrl: './permit-general-detailsreport.component.html',
  styleUrl: './permit-general-detailsreport.component.css'
})
export class PermitGeneralDetailsreportComponent {
