...
@Component({
  selector: 'app-shared-refnumberconfigurations',
  templateUrl: './shared-refnumberconfigurations.component.html',
  styleUrl: './shared-refnumberconfigurations.component.css'
})
export class SharedRefnumberconfigurationsComponent {
@Input() table_name: string;
  ...
  ngOnInit() {
    ...
    this.fetchRegSubTypeData();
    this.fetchRefTypeData();
    this.fetchRefFormatTypeData();
  ...
  this.configService.onLoadConfigurationData(data_submit)
    .subscribe(
      data => {
        this.data_record = data;
        if (this.data_record.success) {
          this.regSubTypeData = this.data_record.data
        }
      },
      error => {
...
fetchRefTypeData() {
  ...
  var data_submit = {
    'table_name': 'par_referencenumbers_types'
  }
  this.configService.onLoadConfigurationData(data_submit)
    .subscribe(
      data => {
        this.data_record = data;
        if (this.data_record.success) {
          this.refTypeData = this.data_record.data
        }
      },
      error => {
  ...
  this.configService.onLoadConfigurationData(data_submit)
    .subscribe(
      data => {
        this.data_record = data;
        if (this.data_record.success) {
          this.refFormatTypeData = this.data_record.data
        }
      },
      error => {
