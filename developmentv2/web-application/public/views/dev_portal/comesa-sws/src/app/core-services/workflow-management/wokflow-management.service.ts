...
export class WokflowManagementService {
  ...
  onEnableWorkflowDetails(dataForm, table_name, title) {
    ...
    return this.http.post(this.baseUrl + '/onEnableWorkflowDetails', dataForm, this.config)
      .pipe(map(data => {
        return data;
      }));
  }
  ...
  getAppWorkflowStageActions(workflow_id) {
    ...
    return this.HttpClient.get(this.baseUrl + '/getAppWorkflowStageActions', this.system)
      .pipe(map(data => {
        return <any>data;
      }));
  }
