...
@Component({
  selector: 'app-emailsetup-types',
  templateUrl: './emailsetup-types.component.html',
  styleUrl: './emailsetup-types.component.css'
})
export class EmailsetupTypesComponent {
table_name: string = 'par_emailssetup_types';
  parameter_name: string = 'email_types';
