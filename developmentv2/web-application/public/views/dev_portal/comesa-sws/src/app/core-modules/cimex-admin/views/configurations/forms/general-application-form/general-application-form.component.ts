...
export class GeneralApplicationFormComponent {
  ...
  constructor(
    ...
    this.table_name = 'par_applicationforms_configuration';
  ...
  onLoadformFieldsData() {
    var data_submit = {
      'table_name': 'par_applicationforms_configuration',
      'is_enabled': 1,
    }
    this.configService.onLoadConfigurationData(data_submit)
      .subscribe(
  ...
  onGetApplicationFormFields() {
    this.spinnerShow('Loading...........');
    var data_submit = {
      'table_name': 'par_applicationforms_fields',
  ...
  onFuncSaveApplicationFormFieldData() {
    ...
    this.configService.onSaveConfigurationDetailsDetails('par_applicationforms_fields', this.applicationFormFieldsFrm.value, 'onsaveConfigData')
      .subscribe(
        response => {
          this.response = response;
          //the details 
