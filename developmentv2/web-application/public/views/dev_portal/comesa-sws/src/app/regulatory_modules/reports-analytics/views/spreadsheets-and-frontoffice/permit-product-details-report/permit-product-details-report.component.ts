...
@Component({
  selector: 'app-permit-product-details-report',
  templateUrl: './permit-product-details-report.component.html',
  styleUrl: './permit-product-details-report.component.css'
})
export class PermitProductDetailsReportComponent {
  ...
  permitProductMenuItems = [
    {
      ...
      icon: 'menu',
      items: [
        { text: "Preview Record", action: 'edit_record', icon: 'fa fa-edit' },
