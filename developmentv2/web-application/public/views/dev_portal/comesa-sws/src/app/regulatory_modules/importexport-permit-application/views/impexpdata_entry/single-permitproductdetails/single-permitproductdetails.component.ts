...
@Component({
  selector: 'app-single-permitproductdetails',
 
  templateUrl: './single-permitproductdetails.component.html',
  styleUrl: './single-permitproductdetails.component.css'
})
export class SinglePermitproductdetailsComponent {
