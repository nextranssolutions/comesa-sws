      ...
      .subscribe(
        data => {
          ...
          if (this.data_record.success) {
            ...
            this.notificationTypeData = this.decryptedPayload;
          }
        },
        error => {
    ...
    this.configService.onLoadConfigurationData(data_submit)
      .subscribe(
        data => {
          ...
          if (this.data_record.success) {
            this.decryptedPayload=this.encryptionService.OnDecryptData(this.data_record.data);
            this.performanceScoringScaleData = this.decryptedPayload;
          }
        },
        error => {
    ...
    this.configService.onLoadConfigurationData(data_submit)
      .subscribe(
        data => {
          ...
          if (this.data_record.success) {
            this.decryptedPayload=this.encryptionService.OnDecryptData(this.data_record.data);
            this.checklistTypesData = this.decryptedPayload;
          }
    ...
    this.configService.onLoadConfigurationData(data_submit)
      .subscribe(
        data => {
          ...
          if (this.data_record.success) {
            this.decryptedPayload=this.encryptionService.OnDecryptData(this.data_record.data);
            this.SystemLangaugesData = this.decryptedPayload;
          }
        },
        error => {
    ...
    this.configService.onLoadConfigurationData(data_submit)
      .subscribe(
        data => {
          ...
          if (this.data_record.success) {
            this.decryptedPayload=this.encryptionService.OnDecryptData(this.data_record.data);
            this.systemLabelsData = this.decryptedPayload;
          }
        },
        error => {
