...
table_name: string = 'tra_email_configurations';
  parameter_name: string = 'email_configurations';
  ...
  actionsMenuItems = [
    ...
    constructor(
        ...
        this.createNewDataFrm = new FormGroup({
          ...
          email_configurations: new FormControl('', Validators.compose([])),
          mail_mailer: new FormControl('', Validators.compose([])),
          mail_host: new FormControl('', Validators.compose([])),
          mail_port: new FormControl('', Validators.compose([])),
          mail_username: new FormControl('', Validators.compose([])),
          mail_password:  new FormControl('', Validators.compose([])),
          mail_encryption: new FormControl('', Validators.compose([])),
          mail_from_address: new FormControl('', Validators.compose([])),
          mail_from_name: new FormControl('', Validators.compose([])),
  ...
  fetchEmailSetUpData() {
    ...
    var data_submit = {
      'table_name': 'par_emailssetup_types'
    }
    this.configService.onLoadConfigurationData(data_submit)
      .subscribe(
        data => {
          this.data_record = data;
          if (this.data_record.success) {
            this.emailSetUpData = this.data_record.data
          }
        },
        error => {
