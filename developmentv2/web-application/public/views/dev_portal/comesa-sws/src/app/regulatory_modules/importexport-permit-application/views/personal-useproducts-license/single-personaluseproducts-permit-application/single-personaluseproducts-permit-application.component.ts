...
@Component({
  selector: 'app-single-personaluseproducts-permit-application',
 
  templateUrl: './single-personaluseproducts-permit-application.component.html',
  styleUrl: './single-personaluseproducts-permit-application.component.css'
})
export class SinglePersonaluseproductsPermitApplicationComponent {
