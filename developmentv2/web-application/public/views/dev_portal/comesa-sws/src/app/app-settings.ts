...
if (app_connection == 'development') {
  ...
  base_url = 'http://localhost:82/nextrans-solutions/comesa-sws/developmentv2/web-application/index.php';
  assets_url = 'http://localhost:82/nextrans-solutions/comesa-sws/developmentv2/web-application/index.php';
