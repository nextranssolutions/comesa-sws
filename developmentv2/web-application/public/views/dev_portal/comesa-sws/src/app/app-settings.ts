...
if (app_connection == 'development') {
  ...
  base_url = 'http://localhost:82/COMESASWS/comesa-sws/developmentv2/web-application/index.php';
  assets_url = 'http://localhost:82/COMESASWS/comesa-sws/developmentv2/web-application/index.php';
