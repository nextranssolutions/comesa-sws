...
if (app_connection == 'development') {
  ...
  base_url = 'http://localhost/nextrans-solution/comesa-sws/developmentv2/web-application/index.php';
  assets_url = 'http://localhost/nextrans-solution/comesa-sws/developmentv2/web-application/index.php';
