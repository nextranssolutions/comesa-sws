...
if (app_connection == 'development') {
  ...
  base_url = 'http://localhost:84/comesa-sws/development/web-application/public/index.php';
  assets_url = 'http://localhost:84/comesa-sws/development/web-application/public/index.php';
