...
@Component({
  selector: 'app-applicant-workflowsetup',
 
  templateUrl: './applicant-workflowsetup.component.html',
  styleUrl: './applicant-workflowsetup.component.css'
})
export class ApplicantWorkflowsetupComponent {
