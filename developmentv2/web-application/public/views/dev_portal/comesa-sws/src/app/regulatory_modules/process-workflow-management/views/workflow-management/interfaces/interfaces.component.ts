...
export class InterfacesComponent {
  table_name: string;
     ...
     iniateEnableDisableRecord() {
       ...
       this.workflowItemsFrm.get('table_name')?.setValue('wf_workflow_interfaces');
     ...
     onDeleteWorkflowDetails() {
       ...
       this.workflowItemsFrm.get('table_name')?.setValue('wf_workflow_interfaces');
       this.workflowService.onDeleteWorkflowsDetails(this.workflowItemsFrm.value, 'wf_workflow_interfaces', this.parameter_name)
         .subscribe(
           response => {
