...
@Component({
  selector: 'app-notificationschedule-type',
  templateUrl: './notificationschedule-type.component.html',
  styleUrl: './notificationschedule-type.component.css'
})
export class NotificationscheduleTypeComponent {
table_name: string = 'par_notificationschedule_types';
  parameter_name: string = 'notification_schedule_types';
  ...
  actionsMenuItems = [
    {
      ...
      items: [
        ...
        { text: "Edit Notification Schedule Type", action: 'edit_record', icon: 'fa fa-edit' },
