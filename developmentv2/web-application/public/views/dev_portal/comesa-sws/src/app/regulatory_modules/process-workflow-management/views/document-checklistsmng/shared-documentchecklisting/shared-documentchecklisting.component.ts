...
@Component({
  selector: 'app-shared-documentchecklisting',

  templateUrl: './shared-documentchecklisting.component.html',
  styleUrl: './shared-documentchecklisting.component.css'
})
export class SharedDocumentchecklistingComponent {
