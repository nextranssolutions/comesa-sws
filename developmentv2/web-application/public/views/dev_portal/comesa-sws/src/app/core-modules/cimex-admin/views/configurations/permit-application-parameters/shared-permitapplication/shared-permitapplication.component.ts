...
@Component({
  selector: 'app-shared-permitapplication',
  templateUrl: './shared-permitapplication.component.html',
  styleUrl: './shared-permitapplication.component.css'
})
export class SharedPermitapplicationComponent {
