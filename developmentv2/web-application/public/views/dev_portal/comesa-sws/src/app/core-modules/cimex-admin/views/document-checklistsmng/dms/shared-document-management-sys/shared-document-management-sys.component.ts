...
@Component({
  selector: 'app-shared-document-management-sys',
  templateUrl: './shared-document-management-sys.component.html',
  styleUrl: './shared-document-management-sys.component.css'
})
export class SharedDocumentManagementSysComponent {
