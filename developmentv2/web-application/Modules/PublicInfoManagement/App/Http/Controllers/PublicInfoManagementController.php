    ...
    public function onSearchExpertsProfileInformation(Request $req)
    {
        try {
            ...
            $sql = DB::table($table_name . ' as t1')
                ...
                ->leftJoin('par_regulatory_functions as t3', 't1.coreregulatory_function_id', 't3.id')
    ...
    public function onLoadHSCodesProductsRegistry(Request $req)
    {
        try {
            ...
            $sql = DB::table("$table_name as t1")
                ...
                ->leftJoin('par_hscodessections as t2', 't3.hscodesection_id', '=', 't2.id')
    ...
    public function onLoadPublicApprovedExpressionofInterests(Request $req)
    {
        try {
            ...
            $sql = DB::table($table_name . ' as t1')
                ...
                ->leftJoin('par_regulatory_functions as t9', 't1.coreregulatory_function_id', 't9.id')
