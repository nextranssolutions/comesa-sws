...
if ( !function_exists( 'onFuncUserGroupUpdate' ) ) {
    function onFuncUserGroupUpdate( $user_groups_ids, $user_id, $loggedInUserId ) {
        return AuthHelper::onFuncUserGroupUpdate( $user_groups_ids, $user_id, $loggedInUserId );
    }
}
